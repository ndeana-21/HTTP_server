...
class ServerConfig {
	public:
		...
		std::vector<Listen> &getListens() {return listens_;};
		std::vector<ServerConfig> &getLocations() {return locations_;};
		std::vector<std::string> &getServerNames() {return server_name_;};
