...
RequestConfig::RequestConfig(Request &request, Listen &host_port,
							std::vector<ServerConfig> &servers, Client &client) :
	request_(request),
...
void		RequestConfig::setTarget(std::string target) {target_ = target;};
std::string &RequestConfig::getMethod() {return request_.method_;};
std::string &RequestConfig::getRoot() {return location_->root_;};
std::string &RequestConfig::getUri() {return location_->uri_;};
std::string &RequestConfig::getRequestTarget() {return request_.target_;};
std::string &RequestConfig::getQuery() {return request_.query_string_;};
std::string &RequestConfig::getCGIBin() {return location_->cgi_bin_;};
std::string &RequestConfig::getBody() {return request_.req_body_;};
std::string &RequestConfig::getAuth() {return location_->credentials_;};
std::string &RequestConfig::getHeader(std::string key) {return request_.headers_[key];};
size_t		&RequestConfig::getClientMaxBodySize() {return location_->client_max_body_size_;};
std::string &RequestConfig::getProtocol() {return request_.protocol_;};
std::string &RequestConfig::getUpload() {return location_->upload_;};
bool		RequestConfig::getAutoindex() {return location_->autoindex_;};
...
std::vector<std::string>	&RequestConfig::getIndexes() {return location_->index_;};
std::map<int, std::string>	&RequestConfig::getErrorPages() {return location_->error_codes_;};
std::vector<std::string>	&RequestConfig::getMethods() {return location_->methods_;};
std::map<std::string, std::string>				&RequestConfig::getCGI() {return location_->cgi_;};
std::map<std::string, std::string, ft::comp>	&RequestConfig::getHeaders() {return request_.headers_;};